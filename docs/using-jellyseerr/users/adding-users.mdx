...
If an [application URL](/using-jellyseerr/settings/users#application-url) is set and [email notifications](using-jellyseerr/notifications/email) have been configured and enabled, Overseerr can automatically generate a password for the new user.
